...
/**
 * Created by Kush on 13-07-2016.
 */
public class DownloadDataTask extends AsyncTask<String, Void, String[]> {

    //openweathermap.org API Key for userID = kgrvr and passowrd = shivkush
    ...
    private final String LOG_TAG = DownloadDataTask.class.getSimpleName();
    ...
    protected String[] doInBackground(String... cityID) {
        try {
            String[] data = getWeatherDataFromJson(downloadData(buildURI(cityID[0], "json", "metric", "7")), 7);
            return data;
        } catch (Exception e) {
    ...
    private String buildURI(String cityID, String format, String units, String days){
        ...
        Log.v(LOG_TAG, "URL Created: " + buildUri.toString());
